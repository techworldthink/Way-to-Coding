...
SELECT bookName AS "BOOKNAME" FROM book;
SELECT bookName AS "BOOKNAME",bookID AS "ID" FROM book;
SELECT CONCAT_WS(', ',bookID,bookName) AS "DETAILS" FROM book;

/*Alias for Tables Example*/
SELECT T.bookId FROM book AS T;
