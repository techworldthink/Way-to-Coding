...
public class WeatherService {
	...
	public Boolean deleteWeatherById(int id) throws StateNotFoundException {
	...
	public Weather updateWeatherDetails(int id, Weather weather) throws StateNotFoundException {
