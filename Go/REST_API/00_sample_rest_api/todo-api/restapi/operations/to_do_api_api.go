...
func NewToDoAPIAPI(spec *loads.Document) *ToDoAPIAPI {
	return &ToDoAPIAPI{
		...
		PostTodosHandler: PostTodosHandlerFunc(func(params PostTodosParams) middleware.Responder {
			return middleware.NotImplemented("operation PostTodos has not yet been implemented")
		}),
	}
}

/*ToDoAPIAPI This is a sample ToDo API. */
type ToDoAPIAPI struct {
	...
	// PostTodosHandler sets the operation handler for the post todos operation
...
func (o *ToDoAPIAPI) Validate() error {
	...
	if o.PostTodosHandler == nil {
		unregistered = append(unregistered, "PostTodosHandler")
	}
...
// Context returns the middleware context for the to do API API
...
func (o *ToDoAPIAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/todos"] = NewPostTodos(o.context, o.PostTodosHandler)
}
